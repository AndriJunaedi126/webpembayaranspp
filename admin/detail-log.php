...
<head>
    ...
    <title>Detail Log Pembayaran | Admin</title>
            ...
            <div class="animated fadeIn">
                ...
                <div class="col-md-5">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <div class="row form-group">
                                <div class="col col-md-3"><label for="id_pembayaran"
                                        class=" form-control-label">ID Pembayaran</label></div>
                                <div class="col-12 col-md-3"><input type="text" id="id_pembayaran" name="id_pembayaran"
                                        placeholder="ID Pembayaran.." class="form-control"
                                        value="<?php echo $data['id_pembayaran'] ?>" readonly></div>
                            </div>
                            <div class="row form-group">
