                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Semua Petugas</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-7">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Semua Petugas</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                    <?php
                                        $sql = "select id_user,username,email from user where role='petugas';";
                                        ...
                                        while($data = mysqli_fetch_array($query)){
                                            ...
                                            <div class='dropdown-menu' aria-labelledby='opsi-siswa'>
                                                <div class='dropdown-menu-content'>
                                                    ...
                                                    href='detail-petugas.php?id=$data[id_user]'>Detail</a>
                                                    <a class='dropdown-item text-warning'
                                                    href='edit-petugas.php?id=$data[id_user]'>Edit</a>
                                                    <a class='dropdown-item text-danger' href='models/Delete-petugas.php?id=$data[id_user]'>Delete</a>
                                                </div>
                                                </div>
                                                </div>
                                            </td>
                    ...
                    <div class="col-md-5">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form action="models/Add-petugas.php" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="username" name="username"
                                                placeholder="Username.." class="form-control" required></div>
                                    </div>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="email" id="email" name="email"
                                                placeholder="Email.." class="form-control" required><small
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="password" id="password"
                                                name="password" placeholder="Password.." class="form-control" required>
                                        </div>
                                    </div>
