                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li class="active">Akses Siswa</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong>Akses Siswa</strong>
                            </div>
                            <div class="card-body card-block">
                                <form action="models/Add-akses-siswa.php" method="post" enctype="multipart/form-data"
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-5"><input type="text" id="username" name="username"
                                                placeholder="Username.." class="form-control" maxlength="25" required>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-5"><input type="email" id="email" name="email"
                                                placeholder="Email.." class="form-control" maxlength="40" required>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                    ...
                                    <div class="col col-md-9">
                                        ...
                                        <button type="reset" class="btn btn-danger btn-sm">
                                            <a href="models/Cancel-akses-siswa.php?id-siswa=<?php echo $id_siswa ?>"
