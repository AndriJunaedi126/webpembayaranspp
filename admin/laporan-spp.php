                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title" v-if="headerText">Laporan SPP</strong>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="typo-headers">
                                    <div class="col-sm-3">
                                        <h4 class="pb-2 display-5">Semua SPP</h4>
                                    </div>
                                    <div class="col-sm-9">
                                    ...
                                    <div class="col-sm-3 mt-3">
                                        <h4 class="pb-2 display-5">SPP Berdasarkan Tahun</h4>
                                    </div>
                                    <div class="col-sm-9 mt-2">
                                        <div class="col-sm-3">
                                            ...
                                            <select name="tahun" id="tahun" class="form-control mt-1" required>
                                                ...
                                                <?php
                                                    $sql = "select tahun from spp group by tahun";
