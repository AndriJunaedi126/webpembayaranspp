...
<head>
    ...
    <title>Log Pembayaran | Siswa</title>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <?php
                                    if(isset($id)){
                                        $sql = "select siswa.id_siswa,id_log,nisn,nama_lengkap,nama_kelas,bulan,tahun,username,jumlah_bayar, waktu_bayar from log_pembayaran inner join pembayaran on log_pembayaran.id_pembayaran = pembayaran.id_pembayaran join siswa on pembayaran.id_siswa = siswa.id_siswa join user on pembayaran.id_user = user.id_user JOIN spp ON pembayaran.id_spp= spp.id_spp JOIN kelas ON siswa.id_kelas = kelas.id_kelas where siswa.id_siswa=$id";
